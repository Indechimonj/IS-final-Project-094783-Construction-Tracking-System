<template>
  <q-popup-edit v-model="model" class="py-3 column gap-3" ref="popupEdit" anchor="top end">
    ...
    <q-form class="row gap-[6px] w-fit" @submit.stop="submit">
      <q-input :type="type" v-model="model" autofocus outlined :label="label" bottom-slots>
        <template #prepend>
